...
ROSTERS: dict[str, list[tuple[str, str, bool, str]]] = {
    "Vido X10-1": [
        ("John", "Doe", True, "NONE"),
        ("Jack", "Smith", False, "NONE"),
        ("Peter", "Brown", False, "NONE"),
        ("Luke", "Wilson", False, "NONE"),
        ("Louis", "Taylor", False, "NONE"),
    ],
    "Vido X10-2": [
        ("Mike", "Johnson", True, "NONE"),
        ("Eli", "Miller", False, "NONE"),
        ("Noah", "Davis", False, "NONE"),
        ("Sam", "Moore", False, "NONE"),
        ("Liam", "Clark", False, "NONE"),
    ],
    "Vido X12-1": [
        ("Finn", "Lewis", True, "NONE"),
        ("Tom", "Walker", False, "NONE"),
        ("Julian", "Hall", False, "NONE"),
        ("Max", "Allen", False, "NONE"),
        ("Dan", "Young", False, "NONE"),
    ],
    "Vido X14-1": [
        ("Barry", "King", True, "NONE"),
        ("Tim", "Scott", False, "NONE"),
        ("Sven", "Green", False, "T1"),
        ("Jelle", "Adams", False, "T1"),
        ("Ruben", "Baker", False, "T3"),
    ],
    "Vido X14-2": [
        ("Wout", "Nelson", True, "NONE"),
        ("Dries", "Carter", False, "NONE"),
        ("Matt", "Mitchell", False, "NONE"),
        ("Stan", "Turner", False, "T1"),
        ("Lars", "Robinson", False, "T4"),
    ],
    "Vido X16-1": [
        ("Annie", "Campbell", True, "NONE"),
        ("Iris", "Parker", False, "NONE"),
        ("Fay", "Evans", False, "NONE"),
        ("Saskia", "Edwards", False, "NONE"),
        ("Imke", "Collins", False, "F"),
    ],
    "Vido M16-1": [
        ("Rick", "Stewart", True, "NONE"),
        ("Michael", "Flores", False, "NONE"),
        ("Coen", "Morris", False, "NONE"),
        ("Dani", "Rivera", False, "NONE"),
        ("Jan", "Cook", False, "F"),
    ],
    "Vido M18-1": [
        ("Ray", "Rogers", True, "NONE"),
        ("Kyle", "Morgan", False, "NONE"),
        ("Lauren", "Peterson", False, "NONE"),
        ("Ian", "Cooper", False, "NONE"),
        ("Milan", "Reed", False, "SENIOR"),
        ("Emre", "Bailey", False, "F"),
    ],
    "Vido M22-1": [
        ("Sam", "Bell", True, "NONE"),
        ("Skip", "Gomez", False, "NONE"),
        ("Bram", "Kelly", False, "NONE"),
        ("Guus", "Howard", False, "NONE"),
        ("Nik", "Ward", False, "SENIOR"),
        ("Davis", "Torres", False, "F"),
    ],
    "Vido VSE1": [
        ("Sonya", "Gray", True, "NONE"),
        ("Tara", "Ramirez", False, "NONE"),
        ("Hank", "James", False, "F"),
        ("Saskia", "Watson", False, "F"),
        ("Iris", "Brooks", False, "SENIOR"),
    ],
    "Vido VSE2": [
        ("Annie", "Campbell", True, "NONE"),
        ("Fay", "Evans", False, "NONE"),
        ("Saskia", "Edwards", False, "F"),
        ("Imke", "Collins", False, "F"),
        ("Hank", "James", False, "SENIOR"),
    ],
    "Vido MSE1": [
        ("Rick", "Stewart", True, "NONE"),
        ("Michael", "Flores", False, "NONE"),
        ("Coen", "Morris", False, "SENIOR"),
        ("Dani", "Rivera", False, "F"),
        ("Tom", "Price", False, "F"),
    ],
}
